...
import { useNavigate } from 'react-router-dom';
import styled from 'styled-components';
import './HeroSectionMobile.css'; // Importing the mobile-specific CSS

// Original styled-components code remains the same
...
const CategoryImage = styled.img.attrs({
...
const CentralLogo = styled.img.attrs({
